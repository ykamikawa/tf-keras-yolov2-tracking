...
def main(args):
    ...
    yolo.train(
        ...
        saved_weights_name=config["model"]["architecture"]
        + "_"
...
if __name__ == "__main__":
    ...
    argparser.add_argument("-c", "--conf", type=str, help="path to configuration file")
    argparser.add_argument("-g", "--gpu_num", default="1", type=str, help="gpu num")
